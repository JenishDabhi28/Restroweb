...
// import Layout from './../components/Layout/Layout';
// import { MenuList } from '../data/data';
// import { useAuth } from './AuthContext'; // Import useAuth hook to check login status

// const Menu = () => {
//   const [selectedItems, setSelectedItems] = useState([]);
//   const [orderedItems, setOrderedItems] = useState([]);
//   const [isOrderPlaced, setIsOrderPlaced] = useState(false);
//   const { isLoggedIn } = useAuth(); // Get isLoggedIn state from context
...
//   // If user is not logged in, display a message prompting to log in first
//   if (!isLoggedIn) {
//     return (
//       <Layout>
//         <Typography variant="h4" style={{ textAlign: 'center', marginTop: '60px' }}>Please log in first to access the menu</Typography>
//       </Layout>
//     );
//   }
